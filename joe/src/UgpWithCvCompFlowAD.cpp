#include <math.h>
#include "../include/UgpWithCvCompFlowAD.h"
...
void UgpWithCvCompFlow_AD::calcEulerFluxMatrices_HLLC_AD(double (*A_L)[5], double (*A_R)[5], double (*A_L_Scal)[6], double (*A_R_Scal)[6],
...
void UgpWithCvCompFlow_AD::calcEulerFluxMatricesCoupled_HLLC_AD(double **A_L, double **A_R,
