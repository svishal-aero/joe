...
void getMem1D(VarType **ptr, int i1, int i2, char *name, bool setZero = false)
{
...
template <class VarType>
void getMem2D(VarType ***ptr, int i1, int i2, int j1, int j2, char *name, bool setZero = false)
{
	VarType **ar = new VarType*[i2-i1+1];
...
template <class VarType>
void getMem3D(VarType ****ptr, int i1, int i2, int j1, int j2, int k1, int k2, char *name, bool setZero = false)
{
	VarType ***ar = new VarType**[i2-i1+1];
...
template <class VarType>
void getMem4D(VarType *****ptr, int i1, int i2, int j1, int j2, int k1, int k2, int l1, int l2, char *name, bool setZero = false)
{
	VarType ****ar = new VarType***[i2-i1+1];
...
template <class VarType>
void getMem5D(VarType ******ptr, int i1, int i2, int j1, int j2, int k1, int k2, int l1, int l2, int m1, int m2, char *name, bool setZero = false)
{
	VarType *****ar = new VarType****[i2-i1+1];
...
template <class VarType>
void getMem6D(VarType *******ptr, int i1, int i2, int j1, int j2, int k1, int k2, int l1, int l2, int m1, int m2, int n1, int n2, char *name, bool setZero = false)
{
	VarType ******ar = new VarType*****[i2-i1+1];
